  ...
  <div class="container-fluid py-4">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="mt-4">
          <a href="sellerdashboard" class="btn btn-primary">← Back to Dashboard</a>
        </div>
        
        <div class="mt-4">
         <a href="sellereditprofile?id=${sessionScope.user.userId}" class="btn btn-sm btn-primary me-1">Edit</a>
        </div>
